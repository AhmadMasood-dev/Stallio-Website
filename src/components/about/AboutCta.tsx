    ...
    <section className="relative overflow-hidden px-4 py-24 sm:px-6 md:py-32 md:pb-36">
      <div className="relative mx-auto w-full max-w-6xl">
        <BezelShell
          ...
          innerClassName="relative overflow-hidden rounded-[calc(2rem-0.375rem)] px-6 py-20 sm:px-10 md:grid md:grid-cols-[1.2fr_0.8fr] md:items-center md:gap-10 md:px-12 md:py-24"
        >
          <div
            aria-hidden
          ...
          >
            ...
            <h2 className="text-foreground mt-5 text-3xl font-semibold tracking-tight text-balance sm:text-4xl lg:text-[2.75rem] lg:leading-[1.1]">
              Put your catalog on a link tonight.
            </h2>
            <p className="text-muted-foreground mt-5 max-w-[38ch] text-base leading-7 sm:text-lg sm:leading-8">
              Free to start. Share stallio.shop/you when you are ready — no
              domain paperwork required.
            </p>
          </motion.div>
