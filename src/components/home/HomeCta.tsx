  ...
  return (
    <section className="relative overflow-hidden px-6 py-24 md:py-32">
      <div className="relative mx-auto w-full max-w-6xl">
        <div className="bg-foreground/[0.03] ring-border/50 relative overflow-hidden rounded-[2rem] p-1.5 ring-1">
          <div className="bg-background dark:bg-card relative overflow-hidden rounded-[calc(2rem-0.375rem)] px-6 py-20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.35)] sm:px-10 md:py-28">
            <div
              aria-hidden
